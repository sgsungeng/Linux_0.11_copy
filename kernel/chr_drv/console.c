...
static unsigned long	origin;		/* Used for EGA/VGA fast scroll	 滚动屏幕起始位置*/
static unsigned long	scr_end;	/* Used for EGA/VGA fast scroll	 结束位置*/
static unsigned long	pos; // 光标在内存中的位置
